...
| **N5** | 🆕 Bảng **3 trạng thái integration** trong README (*thật / mô phỏng / kế hoạch*) + đoạn mô tả **cách tạo synthetic data** *(trong V13)* | Không mục nào khai sai nhãn | 1h | 🔴 **07/08** |
...
### 🟠 LÊ ĐỨC TÙNG — VHAL & Safety (49.5h) · ~~DTC~~ *T10 đã bỏ 29/07*
...
| **31/07** | 🔴 L5a Intent — **5 lệnh xương sống** | 🔴 V8 Harness v1 | 🔴 T3 VhalRepo · T4 door_lock · T5 Guard G1 | 🔴 D2 HMI · D3 real-time |
| | ⚖️ **MỐC CÂN 1 — 21:30** ||||
| **01/08** | 🟡 L6 TTS · 🆕 **N2 Product Card** | *(hỗ trợ tích hợp)* | *(hỗ trợ tích hợp)* | 🟡 D4 usb.img 20:00 |
...
> 📌 **Việc ngày 29/07 xem `08-BAREM-VONG-2-CHINH-THUC.md` PHẦN 9.** Đầu việc gấp nhất hôm nay:
> Long đăng file `08` vào nhóm + gửi mentor 3 câu hỏi mới. **Quyết định bỏ T10 DTC đã chốt** —
> standup chỉ cần thông báo và xác nhận Tùng nhận N3b + N4b.
