...
class GrammarAblationTest {
    ...
    private fun VehicleIntent.label(): String = when (this) {
        ...
        is VehicleIntent.MediaPlay -> "MediaPlay(${query.orEmpty()})"
        VehicleIntent.MediaPause -> "MediaPause"
        VehicleIntent.MediaNext -> "MediaNext"
        is VehicleIntent.RadioTune -> "RadioTune(${query.orEmpty()})"
        VehicleIntent.RadioNextStation -> "RadioNextStation"
